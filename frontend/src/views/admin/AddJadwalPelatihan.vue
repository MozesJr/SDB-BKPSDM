<template>
  <div class="flex flex-wrap">
    <div class="w-full px-4">
      ...
      >
        <div class="px-6 py-4">
          <h3 class="text-2xl mb-4">Add Jadwal Pelatihan</h3>
          <form @submit.prevent="addJadwalPelatihan">
            <div class="mb-3 pt-0">
              <label
    ...
    async addJadwalPelatihan() {
      ...
      try {
        ...
        Swal.fire({
          icon: "success",
          title: "Berhasil!",
          text: "Jadwal pelatihan berhasil ditambahkan.",
          showConfirmButton: false,
          timer: 1500,
        });
        this.$router.push("/admin/jadwal-pelatihan");
      } catch (error) {
        console.error("Error adding jadwal pelatihan:", error);
        Swal.fire({
          icon: "error",
          title: "Gagal!",
          text: "Terjadi kesalahan saat menambahkan jadwal pelatihan.",
        });
      }
    },
  },
