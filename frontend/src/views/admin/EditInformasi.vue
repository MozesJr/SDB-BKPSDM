<template>
  <div class="flex flex-wrap">
    <div class="w-full px-4">
      ...
      >
        <div class="px-6 py-4">
          <h3 class="text-2xl mb-4">Edit Informasi</h3>
          <form @submit.prevent="updateInformasi">
            ...
            <div class="mb-3 pt-0">
              ...
              <ckeditor
                ...
                :config="editorConfig"
                class="border border-blueGray-300"
              ></ckeditor>
            </div>
            <div class="mb-3 pt-0">
              <label
...
export default {
  ...
  methods: {
    async fetchInformasi(id) {
      ...
      const informasi = response.data;
      this.form.judul = informasi.judul;
      this.form.deskripsi = informasi.deskripsi;
      this.form.user = informasi.user._id;
      this.form.image = informasi.image;
      this.imagePreview = `http://localhost:8000/uploads/${informasi.image}`;
    },
    async fetchUsers() {
    ...
    async updateInformasi() {
      ...
      try {
        await axios.put(
          `http://localhost:8000/api/informasi/${this.$route.params.id}`,
          formData
        );
        Swal.fire({
          icon: "success",
          title: "Berhasil!",
          text: "Data informasi berhasil diperbarui.",
        ...
        Swal.fire({
          icon: "error",
          title: "Gagal!",
          text: "Terjadi kesalahan saat memperbarui data informasi.",
        });
      }
    },
  },
